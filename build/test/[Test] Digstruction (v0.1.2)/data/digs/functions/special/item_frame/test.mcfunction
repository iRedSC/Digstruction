...
execute if data entity @s Item.tag.digs{type:"cage_trap"} run function digs:special/item_frame/set/cage_trap
execute if data entity @s Item.tag.digs{type:"launch_pad"} run function digs:special/item_frame/set/launch_pad
